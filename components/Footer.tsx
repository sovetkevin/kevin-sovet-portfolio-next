  ...
  return (
    <footer className="px-6 md:px-24 py-12 flex flex-col md:flex-row justify-between items-center border-t border-gray-200 dark:border-gray-700 mt-24 gap-8">
      ...
      <div className="order-2 md:order-3 flex gap-8 text-gray-600 dark:text-gray-400 text-sm leading-relaxed max-w-sm">
        <a href="mailto:kevin.sovet@gmail.com" className="hover:text-gray-900 dark:hover:text-gray-50 transition-colors">Email</a>
        <a href="https://www.linkedin.com/in/kevinsovet/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 dark:hover:text-gray-50 transition-colors">LinkedIn</a>
      </div>
    </footer>
  );
};
